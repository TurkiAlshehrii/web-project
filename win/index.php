...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    ...
    <div class="continer">
        <h3>للدخول على السحب اتبع ما يلي : </h3>
        <ul class="list-group list-group-flush">
            <li class="list-group-item">تابع البث المباشر</li>
            <li class="list-group-item">سأقوم ببث مباشر لمده ساعه</li>
            <li class="list-group-item">بنهايه البث سيتم اختيار اسم من قاعده البيانات بشكل عشوائي</li>
            <li class="list-group-item">الرابح سيحصل على نسخه مجانيه من برنامج</li>
        </ul>
